...
final class Bootstrap
{
    ...
    public static function registerMenus()
    {
        register_nav_menus(
            array(
                self::MENUS['header'] => __('Header', TM_TEXTDOMAIN),
                self::MENUS['footer'] => __('Footer', TM_TEXTDOMAIN),
                self::MENUS['switcher'] => __('Switcher', TM_TEXTDOMAIN),
                self::MENUS['auth'] => __('Auth', TM_TEXTDOMAIN),
            )
        );
    }
    ...
    public static function bootstrap_switcher_menu()
    {
        wp_nav_menu(array(
            'theme_location' => self::MENUS['switcher']
        ));
    }
    public static function bootstrap_auth_menu()
    {
        wp_nav_menu(array(
            'theme_location' => self::MENUS['auth']
        ));
    }
